...
python process.py -ds eeg -df chan28 > ../eeg/eeg_chan28.json

mkdir ../climate
python process.py -ds temperature -df t13-14 > ../climate/climate_13-14.json
...
python process.py -ds stock2 -df tm > ../stock/stock_tm.json
